...
class BackendStub(object):
    ...
    def __init__(self, channel):
        ...
        self.predict = channel.unary_unary(
                '/Backend/predict',
                request_serializer=backend__pb2.img_path.SerializeToString,
                response_deserializer=backend__pb2.label.FromString,
                )
...
def add_BackendServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'predict': grpc.unary_unary_rpc_method_handler(
                    servicer.predict,
                    request_deserializer=backend__pb2.img_path.FromString,
                    response_serializer=backend__pb2.label.SerializeToString,
            ),
    }
...
class Backend(object):
    ...
    def predict(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Backend/predict',
            backend__pb2.img_path.SerializeToString,
            backend__pb2.label.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
